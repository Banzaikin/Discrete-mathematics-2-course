...
namespace completeness_system
{
    class Program
    {
        ...
        {
            string[] menu = {
                "1. Ввод системы функций",
                "2. Расчет полноты системы функций",
            ...
            do
            {
                ...
                {
                    case 1:
                        functions = InputSystem();
                        break;
                    case 2:
                        CompletenessSystem(functions);
                        break;
                    case 3:
        ...
        {
            var size = InputInt("Введите размер системы: ");
            string[] functions = new string[size];

            for (int i = 0; i < size; i++)
            {
                functions[i] = InputVector($"Введите {i + 1} функцию: ");
            }
